...
%设计常数
r=3/5;
lambda110=4000;lambda111=4000;lambda210=15000;lambda211=15000;
...
%初值
z1_0=0.2;z2_0=0.1;z3_0=0;p1_0=0.3;p2_0=0.1;p3_0=0;
psi110_0=0.4;psi111_0=0.2;psi210_0=0.4;psi211_0=0.2;
thetaf111_0=0.6;thetaf112_0=0.6;thetaf113_0=0.6;thetaf114_0=0.6;thetaf115_0=0.6;thetaf116_0=0.6;
...
psi210=zeros(n,1);psi211=zeros(n,1);psi110=zeros(n,1);psi111=zeros(n,1);
E111=zeros(n,1);E112=zeros(n,1);E121=zeros(n,1);E211=zeros(n,1);E212=zeros(n,1);E221=zeros(n,1);
rho1=zeros(n,1);rho2=zeros(n,1);
thetaf111=zeros(n,1);thetaf112=zeros(n,1);thetaf113=zeros(n,1);thetaf114=zeros(n,1);thetaf115=zeros(n,1);thetaf116=zeros(n,1);
thetaf117=zeros(n,1);thetaf118=zeros(n,1);thetac111=zeros(n,1);thetac112=zeros(n,1);thetac113=zeros(n,1);thetac114=zeros(n,1);
thetac115=zeros(n,1);thetac116=zeros(n,1);thetac117=zeros(n,1);thetac118=zeros(n,1);thetaa111=zeros(n,1);thetaa112=zeros(n,1);
thetaa113=zeros(n,1);thetaa114=zeros(n,1);thetaa115=zeros(n,1);thetaa116=zeros(n,1);thetaa117=zeros(n,1);thetaa118=zeros(n,1);
thetaf121=zeros(n,1);thetaf122=zeros(n,1);thetaf123=zeros(n,1);thetaf124=zeros(n,1);thetaf125=zeros(n,1);thetaf126=zeros(n,1);
thetaf127=zeros(n,1);thetaf128=zeros(n,1);thetac121=zeros(n,1);thetac122=zeros(n,1);thetac123=zeros(n,1);thetac124=zeros(n,1);
thetac125=zeros(n,1);thetac126=zeros(n,1);thetac127=zeros(n,1);thetac128=zeros(n,1);thetaa121=zeros(n,1);thetaa122=zeros(n,1);
thetaa123=zeros(n,1);thetaa124=zeros(n,1);thetaa125=zeros(n,1);thetaa126=zeros(n,1);thetaa127=zeros(n,1);thetaa128=zeros(n,1);
thetaf211=zeros(n,1);thetaf212=zeros(n,1);thetaf213=zeros(n,1);thetaf214=zeros(n,1);thetaf215=zeros(n,1);thetaf216=zeros(n,1);
thetaf217=zeros(n,1);thetaf218=zeros(n,1);thetac211=zeros(n,1);thetac212=zeros(n,1);thetac213=zeros(n,1);thetac214=zeros(n,1);
thetac215=zeros(n,1);thetac216=zeros(n,1);thetac217=zeros(n,1);thetac218=zeros(n,1);thetaa211=zeros(n,1);thetaa212=zeros(n,1);
thetaa213=zeros(n,1);thetaa214=zeros(n,1);thetaa215=zeros(n,1);thetaa216=zeros(n,1);thetaa217=zeros(n,1);thetaa218=zeros(n,1);
thetaf221=zeros(n,1);thetaf222=zeros(n,1);thetaf223=zeros(n,1);thetaf224=zeros(n,1);thetaf225=zeros(n,1);thetaf226=zeros(n,1);
thetaf227=zeros(n,1);thetaf228=zeros(n,1);thetac221=zeros(n,1);thetac222=zeros(n,1);thetac223=zeros(n,1);thetac224=zeros(n,1);
thetac225=zeros(n,1);thetac226=zeros(n,1);thetac227=zeros(n,1);thetac228=zeros(n,1);thetaa221=zeros(n,1);thetaa222=zeros(n,1);
thetaa223=zeros(n,1);thetaa224=zeros(n,1);thetaa225=zeros(n,1);thetaa226=zeros(n,1);thetaa227=zeros(n,1);thetaa228=zeros(n,1);

thetaf11=zeros(n,1);thetac11=zeros(n,1);thetaa11=zeros(n,1);thetaf12=zeros(n,1);thetac12=zeros(n,1);thetaa12=zeros(n,1);
thetaf21=zeros(n,1);thetac21=zeros(n,1);thetaa21=zeros(n,1);thetaf22=zeros(n,1);thetac22=zeros(n,1);thetaa22=zeros(n,1);
%设置初始条件
z1(1)=z1_0;z2(1)=z2_0;z3(1)=z3_0;p1(1)=p1_0;p2(1)=p2_0;p3(1)=p3_0;
...
E211(1)=E211_0;E212(1)=E212_0;E221(1)=E221_0;
...
for i=1:n-1
    ...
    w1(i)=(2*transpose(P11L)*[z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i)])*(H221(z1(i))+H121(z1(i)))/...
        ((transpose(P11L)*[z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i)])*(transpose(P11L)*[z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i)])+psi1);
    
    wj111(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[1;1;1;1;1;1;1]))^2/(2^2));
    wj112(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[2;2;2;2;2;2;2]))^2/(2^2));
    wj113(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[3;3;3;3;3;3;3]))^2/(2^2));
    wj114(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[4;4;4;4;4;4;4]))^2/(2^2));
    wj115(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[5;5;5;5;5;5;5]))^2/(2^2));
    wj116(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[6;6;6;6;6;6;6]))^2/(2^2));
    wj117(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[7;7;7;7;7;7;7]))^2/(2^2));
    wj118(i)=exp(-(norm([z1(i);z2(i);z1(i)-0.8*sin(t(i));-0.8*sin(t(i));z1(i)-0.8*sin(t(i))-E111(i);z2(i)-0.8*cos(t(i))-E112(i);z2(i)-0.8*cos(t(i))]-...
        [8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[8;8;8;8;8;8;8]))^2/(2^2));
    
     a1(i)=-A11*[z1(i)-0.8*sin(t(i));z2(i)-0.8*cos(t(i))]+A11*phi11*[(z1(i)-0.8*sin(t(i))-E111(i))^r;...
        (z2(i)-0.8*cos(t(i))-E112(i))^r]-0.8*sin(t(i))-(thetaf111(i)*wf111(i)+thetaf112(i)*wf112(i)+thetaf113(i)*wf113(i)...
    ...
    thetaf111(i+1)=thetaf111(i)+h*tau11*(wf111(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf111(i)-thetaf111(i));
    thetaf112(i+1)=thetaf112(i)+h*tau11*(wf112(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf112(i)-thetaf112(i));
    thetaf113(i+1)=thetaf113(i)+h*tau11*(wf113(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf113(i)-thetaf113(i));
    thetaf114(i+1)=thetaf114(i)+h*tau11*(wf114(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf114(i)-thetaf114(i));
    thetaf115(i+1)=thetaf115(i)+h*tau11*(wf115(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf115(i)-thetaf115(i));
    thetaf116(i+1)=thetaf116(i)+h*tau11*(wf116(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf116(i)-thetaf116(i));
    thetaf117(i+1)=thetaf117(i)+h*tau11*(wf117(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf117(i)-thetaf117(i));
    thetaf118(i+1)=thetaf118(i)+h*tau11*(wf118(i)*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L-sigmaf11*thetaf118(i)-thetaf118(i));
    ...
    rho1(i+1)=rho1(i)+h*(etarho1*[z1(i)-0.8*sin(t(i))-E111(i) z2(i)-0.8*cos(t(i))-E112(i)]*P11L*w1(i)...
   ...
   thetaa128(i+1)=thetaa128(i)+h*(-(wj128(i)*wj121(i)*(betaa12*(thetaa121(i)-thetac121(i))+betac12*thetac121(i))+wj128(i)*wj122(i)*(betaa12*(thetaa122(i)-thetac122(i))+betac12*thetac122(i))+...
    ...
    wj211(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[1;1;1;1;1;1;1]))^2/(2^2));
    wj212(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[2;2;2;2;2;2;2]))^2/(2^2));
    wj213(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[3;3;3;3;3;3;3]))^2/(2^2));
    wj214(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[4;4;4;4;4;4;4]))^2/(2^2));
    wj215(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[5;5;5;5;5;5;5]))^2/(2^2));
    wj216(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[6;6;6;6;6;6;6]))^2/(2^2));
    wj217(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[7;7;7;7;7;7;7]))^2/(2^2));
    wj218(i)=exp(-(norm([p1(i);p2(i);p1(i)-0.6*cos(t(i))-E211(i);p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i));-0.6*cos(t(i));p2(i)+0.6*sin(t(i))-E212(i)]...
        -[8.5;8.5;8.5;8.5;8.5;8.5;8.5]+[8;8;8;8;8;8;8]))^2/(2^2));
    
    w2(i)=(2*transpose(P21L)*[p1(i)-0.6*cos(t(i))-E211(i);p2(i)+0.6*sin(t(i))-E212(i)])*(H122(p1(i))+H222(p1(i)))/...
        ((transpose(P21L)*[p1(i)-0.6*cos(t(i))-E211(i);p2(i)+0.6*sin(t(i))-E212(i)])*...
        (transpose(P21L)*[p1(i)-0.6*cos(t(i))-E211(i);p2(i)+0.6*sin(t(i))-E212(i)])+psi2);
    
    a2(i)=-A21*[p1(i)-0.6*cos(t(i));p2(i)+0.6*sin(t(i))]+A21*phi21*[(p1(i)-0.6*cos(t(i))-E211(i))^r;...
        (p2(i)+0.6*sin(t(i))-E212(i))^r]-0.6*cos(t(i))-(thetaf211(i)*wj211(i)+thetaf212(i)*wj212(i)+thetaf213(i)*wj213(i)...
    ...
    thetaf211(i+1)=thetaf211(i)+h*tau21*(wf211(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
        -sigmaf21*thetaf211(i)-thetaf211(i));
    thetaf212(i+1)=thetaf212(i)+h*tau21*(wf212(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
        -sigmaf21*thetaf212(i)-thetaf212(i));
    thetaf213(i+1)=thetaf213(i)+h*tau21*(wf213(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
        -sigmaf21*thetaf213(i)-thetaf213(i));
    thetaf214(i+1)=thetaf214(i)+h*tau21*(wf214(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
        -sigmaf21*thetaf214(i)-thetaf214(i));
    thetaf215(i+1)=thetaf215(i)+h*tau21*(wf215(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
        -sigmaf21*thetaf215(i)-thetaf215(i));
    thetaf216(i+1)=thetaf216(i)+h*tau21*(wf216(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
        -sigmaf21*thetaf216(i)-thetaf216(i));
    thetaf217(i+1)=thetaf217(i)+h*tau21*(wf217(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
        -sigmaf21*thetaf217(i)-thetaf217(i));
    thetaf218(i+1)=thetaf218(i)+h*tau21*(wf218(i)*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.6*sin(t(i))-E212(i)]*P21L...
   ...
   thetaa212(i+1)=thetaa212(i)+h*(-(wj212(i)*wj211(i)*(betaa21*(thetaa211(i)-thetac211(i))+betac21*thetac211(i))+(wj212(i)*wj212(i)+sigmaj21)*(betaa21*(thetaa212(i)-thetac212(i))+betac21*thetac212(i))+...
    ...
    rho2(i+1)=rho2(i)+h*(etarho2*[p1(i)-0.6*cos(t(i))-E211(i) p2(i)+0.5*sin(t(i))-E212(i)]*P21L*w2(i)...
    ...
    z1(i+1)=z1(i)+z2(i)*h;
    z2(i+1)=z2(i)+(z3(i)-0.8*z2(i)+sin(z2(i))-0.5*(z1(i)-p1(i)))*h;
    z3(i+1)=z3(i)+(u1(i)-0.6*z2(i)+0.2*exp(-(z2(i))^2))*h;
    p1(i+1)=p1(i)+p2(i)*h;
    p2(i+1)=p2(i)+(p3(i)-0.7*p2(i)+sin(p2(i))+0.5*(z1(i)-p1(i)))*h;
    p3(i+1)=p3(i)+(u2(i)-0.5*p2(i)-0.3*(p2(i))^2)*h;
end
%跟踪效果
figure;
